...
plt.yscale("log")
plt.plot(Qval, y2horizon, '.', Qval, y2c0(Qval)*cgtr0fit(Qval, 7.5, 7.0, 1.9e-8, 3.4e-6) )
...
int_file = path + 'results_c3_Q' + str(Qmin) + '-' + str(Qmax) + '_' + str(Nruns) + 'runs.txt'
...
path  = '/Users/vikasaragam/Documents/Python/'
int_file = path + 'results_c3_Q100.txt'
np.savetxt(int_file, data)

#%% Import horizon crossing data

path  = '/Users/vikasaragam/Documents/Python/'
file = 'results_c3_Q10-150_1000runs.txt'#'results_c1_Q10-3000_1000runs.txt'
